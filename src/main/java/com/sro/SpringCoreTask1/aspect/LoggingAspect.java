...
public class LoggingAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.sro.SpringCoreTask1.controller.v1.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.sro.SpringCoreTask1.controller.v1.*.*(..))", throwing = "exception")
