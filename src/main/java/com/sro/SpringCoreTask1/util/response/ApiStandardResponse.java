...
public record ApiStandardResponse<T>(
        ...
        @Schema(description = "Reponse message", example = "Operation completed successfully") String message,

        @Schema(description = "Request path", example = "/api/v1/trainees") String path,
