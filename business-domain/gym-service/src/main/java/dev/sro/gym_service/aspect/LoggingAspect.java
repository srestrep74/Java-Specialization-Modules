package dev.sro.gym_service.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* dev.sro.gym_service.service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* dev.sro.gym_service.service.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* dev.sro.gym_service.service.*.*(..))", throwing = "exception")
    ...
    @Before("execution(* dev.sro.gym_service.repository.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* dev.sro.gym_service.repository.*.*(..))", throwing = "exception")
    ...
    @Before("execution(* dev.sro.gym_service.controller.v1.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* dev.sro.gym_service.controller.v1.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* dev.sro.gym_service.controller.v1.*.*(..))", throwing = "exception")
