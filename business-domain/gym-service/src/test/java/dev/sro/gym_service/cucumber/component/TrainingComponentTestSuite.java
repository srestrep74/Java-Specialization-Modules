...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty, html:target/cucumber-reports/training-component-report.html, json:target/cucumber-reports/training-component-report.json")
...
public class TrainingComponentTestSuite {
} 