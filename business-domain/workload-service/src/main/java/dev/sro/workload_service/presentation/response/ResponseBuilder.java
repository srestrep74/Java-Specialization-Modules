...
public class ResponseBuilder {
    ...
    public static <T> ResponseEntity<ApiStandardResponse<T>> workloadProcessed(T data) {
        return success(HttpStatus.OK, "Workload processed successfully", data);
    }

    public static <T> ResponseEntity<ApiStandardResponse<T>> summaryRetrieved(T data) {
        return success(HttpStatus.OK, "Summary retrieved successfully", data);
    }
} 