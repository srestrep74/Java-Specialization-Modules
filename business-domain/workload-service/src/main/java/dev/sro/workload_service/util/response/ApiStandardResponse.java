...
public record ApiStandardResponse<T>(
        @Schema(description = "Timestamp when the response was generated", example = "2021-01-01T00:00:00Z") LocalDateTime timestamp,

        @Schema(description = "HTTP status code", example = "200") int status,

        @Schema(description = "Response message", example = "Operation completed successfully") String message,

        @Schema(description = "Request path", example = "/api/v1/trainers") String path,
